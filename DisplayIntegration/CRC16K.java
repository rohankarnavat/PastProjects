...
/**
 * This code was derived from code a generated by https://pycrc.org
 *
 * \file
 * Functions and types for CRC checks.
 *
 * Generated on Tue Sep 10 17:00:57 2019
...
public class CRC16K {
	...
	public final static int update(final int crc, final byte[] buffer,
		...
		int c = crc;
		for (int i = 0; i < len; i++) {
            c = (c >>> 8) ^ CRC16KTABLE[(c ^ buffer[i]) & 0xff];
        }
		return c;
		
	}
	
	public final static int finalize(int crc)
	{
